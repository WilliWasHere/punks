...
<body>
    <div class="col-6 mt-2 ms-2">
    <a class="btn btn-info" href="tampilberas.php" role="button">Beras</a>
    <a class="btn btn-info" href="tampilPembayaran.php" role="button">Ddaftar Pembayaran</a>
    <a class="btn btn-info" href="tambahPembayaran.php" role="button">Pembayaran</a>
</div>
    <div class="card col-6 ms-2 mt-2">
        <div class="card-header">
            <div class="row">
                <div class="col-6">
                    <p class="text-start">Tampil Data Beras</p>
                </div>
                <div class="col-6">
                    <p class="text-end"><a href="tambahBeras.php" class="btn btn-success">Tambah Data Beras</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <table class="table table-bordered">
                <tr>
                    ...
                    <th>Harga Zakat Beras Perjiwa</th>
                    <th>Aksi</th>
                </tr>
                                <tr>
                    <td>1</td>
                    ...
                    <td>35000</td>
                    <td>
                        <a href="editBeras.php?id=1" class="btn btn-warning">Edit</a>
                        <a href="hapusBeras.php?id=1" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                                <tr>
                    <td>1</td>
                    ...
                    <td>4</td>
                    <td>
                        <a href="editBeras.php?id=4" class="btn btn-warning">Edit</a>
                        <a href="hapusBeras.php?id=4" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                                <tr>
                    <td>1</td>
                    ...
                    <td>4</td>
                    <td>
                        <a href="editBeras.php?id=5" class="btn btn-warning">Edit</a>
                        <a href="hapusBeras.php?id=5" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                                <tr>
                    <td>1</td>
                    ...
                    <td>50</td>
                    <td>
                        <a href="editBeras.php?id=6" class="btn btn-warning">Edit</a>
                        <a href="hapusBeras.php?id=6" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                                <tr>
                    <td>1</td>
                    ...
                    <td>1</td>
                    <td>
                        <a href="editBeras.php?id=8" class="btn btn-warning">Edit</a>
                        <a href="hapusBeras.php?id=8" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                                <tr>
                    <td>1</td>
                    ...
                    <td>1</td>
                    <td>
                        <a href="editBeras.php?id=9" class="btn btn-warning">Edit</a>
                        <a href="hapusBeras.php?id=9" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                                <tr>
                    <td>1</td>
                    ...
                    <td>1</td>
                    <td>
                        <a href="editBeras.php?id=10" class="btn btn-warning">Edit</a>
                        <a href="hapusBeras.php?id=10" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                            </table>
        </div>
