...
<body>
    ...
    <div class="card col-6 ms-2 mt-2">
        <div class="card-header">
            <div class="row">
                <div class="col-6">
                    <p class="text-start">Tampil Data Pembayaran</p>
                </div>
                <div class="col-6">
                    <p class="text-end"><a href="laporan.php" class="btn btn-success">Download Laporan</a></p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <table class="table table-bordered">
                <tr>
                    ...
                    <td>20</td>
                    <td>
                        <a href="hapus.php?id=4" class="btn btn-danger">Hapus</a>
                    </td>
                </tr>
                                <tr>
                    <td>3</td>
