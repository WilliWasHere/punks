        ...
        <div class="card col-6 mt-2 ms-2">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 col-12">
                    ...
                    <div class="col-6"> <textarea name="alamat" id="" cols="30" rows="10"></textarea> <div>
                </div>
                <div class="mb-3">
                    <label class="form-label">Jumlah Jiwa</label>
                    <div class="col-6"> 
                        <select name="jiwa" id="jiwa">
                ...
                <div class="mb-3 col-12">
                    <label class="form-label">Harga Beras Perliter</label>
                    <div class="col-6"> 
                        <select name="harga_beras_asli" id="harga">
                            <option value="">pilih</option>
                            <option value="1,35000">10.000 / liter</option><option value="4,4">11.500</option><option value="5,4">11.500</option><option value="6,50">20.000</option><option value="8,1">32600</option><option value="9,1">32600</option><option value="10,1">32600</option>                        </select>
                    </div>
                </div>
                <div class="mb-3 col-12">
                    <label class="form-label"> Total Yang Harus Di Bayar</label>
                    <div class="col-6"> <input type="hidden" name="harga_beras" id="harga_beras"></div>
                    <div class="col-6"> <input type="hidden" name="totalJiwa" id="totalJiwa"></div>
                    <div class="col-6"> <input type="text" name="totalHarga" id="totalHarga"></div>
                </div>
                <div class="mb-3 col-12">
                    <label class="form-label">Di Bayar </label>
                    <div class="col-6"> <input type="text" name="bayar" id="bayar"></div>
                </div>
                <div class="mb-3 col-12">
                    <label class="form-label">Kembalian </label>
                    <div class="col-6"> <input type="text" name="kembalian" id="kembalian"></div>
                </div>
...
<script type="text/javascript">
    $('#jiwa').on('change', function(){
        let selectedJiwa = $('#jiwa').val();        
        $('#totalJiwa').val(selectedJiwa);
        
        let harga_beras = $("#harga_beras").val();
        let totalJiwa = $("#totalJiwa").val();
        let totalHarga = parseInt(harga_beras)*parseInt(totalJiwa);
        $("#totalHarga").val(totalHarga);
    });

    $('#harga').on('change', function(){
        let selectedHarga = $('#harga').val();        
        // $('#terima').val(selectedHarga);
        // console.log(selectedHarga);
        let convert = selectedHarga.split(",");
        // console.log(convert[1]);
        $('#harga_beras').val(convert[1]);
    ...
    $(document).ready(function(){
        $("#totalHarga, #bayar").keyup(function(){
            var totalHarga = $("#totalHarga").val();
            var bayar = $("#bayar").val();
            var kembalian = parseInt(bayar)-parseInt(totalHarga);
